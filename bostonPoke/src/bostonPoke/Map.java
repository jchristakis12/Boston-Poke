...
public class Map extends Application{
	...
	public void start(Stage primaryStage) throws Exception{
		...
		ImageView imgView7 = new ImageView(character);
		imgView7.setLayoutX(820);
		imgView7.setLayoutY(750);
		imgView7.setFitHeight(70);
		imgView7.setFitWidth(100);
		
		imgView7.setOnKeyPressed(new EventHandler<KeyEvent>() {
			
			@Override
			public void handle(KeyEvent event) {
				// TODO Auto-generated method stub
				if (event.getCode() == KeyCode.LEFT) {
					imgView7.setX(imgView7.getX() - 10);
				}
				if (event.getCode() == KeyCode.RIGHT) {
					imgView7.setX(imgView7.getX() + 10);
				}
				if (event.getCode() == KeyCode.UP) {
					imgView7.setY(imgView7.getY() - 10);
				}
		...
		pane.getChildren().addAll( imgView1, imgView2, imgView3, imgView4, imgView5, imgView6, door, wall1, wall2, wall3, wall4, wall5, imgView7, imgView8, imgView9, imgView10, imgView11, imgView12, imgView13, imgView14, imgView15, imgView16, imgView17, imgView18, imgView19, imgView20, imgView22, imgView23);
